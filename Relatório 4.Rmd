...
setwd("~/Documentos/UnB/Listas e Trabalhos/Data Science/Relatório 4")
```
...
Com base no apresentado, segue uma descrição um pouco mais detalhada das seis fases de um projeto no CRISP-DM, interpretadas no contexto deste relatório.
